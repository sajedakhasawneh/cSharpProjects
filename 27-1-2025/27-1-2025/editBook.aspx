<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editBook.aspx.cs" Inherits="_27_1_2025.editBook" %>
...
<%--                  <div class="d-flex flex-row align-items-center mb-4">
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <asp:Button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg" ID="editbook" runat="server" text="Edit Book" OnClick="editbook_Click"></asp:Button>
                  </div>

                      <asp:Label ID="Editmessage" runat="server"  Visible="false"></asp:Label>
